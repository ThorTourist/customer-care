...
const Footer = () => {
    return (
      <div className="max-w-[1140px] mx-auto mt-5 text-center md:text-left">
        <footer className="text-white footer sm:footer-horizontal bg-black  p-10 grid  grid-cols-1 md:grid-cols-5 space-x-3">
          <nav className="col-span-1 md:col-span-2 mx-auto">
            <h1 className="mb-4 font-bold text-center mx-auto md:mx-0">
              CS — Ticket System
            </h1>
            <p>
